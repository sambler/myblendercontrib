...
bl_info = {
    ...
    "wiki_url": "http://wiki.blender.org/index.php/Extensions:2.5/Py/Scripts/Modeling/Edge_Slice",
    "tracker_url": "http://projects.blender.org/tracker/?func=detail&aid=25227"
   }
...
# can change this to 1.0e-6 ..if you need

#   gets distance between two given points
